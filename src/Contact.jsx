...
const [data, setData] = useState({
    ...
    const formSubmit = (e) => {
        e.preventDefault();
        alert(`My name is ${data.fullname}. My mobile number is ${data.phone}. My email is ${data.email}. Here is the message which I want ${data.msg}.`);
    }
    return (
        <>
            <div className="my-5">
...
<div class="mb-3">
  ...
  rows="3" 
  name="" value={data.msg} onChange={InputEvent}
  >
